...
public class RecoveryIT {
  ...
  private final static String PASSWORD_RECOVERY_URL = "/bigdata-web/#!/passwordRecovery?key=";
  private final static String QR_CODE_RECOVERY_URL = "/bigdata-web/#!/qrRecovery?key=";
